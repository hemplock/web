...
def help(request):
    faq = {
        'Product': [
        {
            ...
            'a': _("The <a href=http://35.233.178.123:8000/explorer>Test Issue Explorer</a> contains test of issues that are ready to be paid out as soon as they are turned around.
