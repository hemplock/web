...
def mission(request):
    ...
    context = {
        'active': 'mission',
        'title': 'Mission',
        'card_title': _('eXitcoin is a mission-driven organization.'),
        'card_desc': _('Our mission is to grow open email_founders.'),
...
def help(request):
    faq = {
        'Product': [
        {
            'q': _('I am a supporter or sposor of a potential tester I want sign them up. Where can I start?'),
            'a': _("The <a href=https://gitcoin.co/explorer>Funded Test Issue Explorer</a> contains test of issues that are ready to be paid out as soon as they are turned around.
            Check out the developer guide at <a href=https://gitcoin.co/help/dev>https://gitcoin.co/help/dev</a>.")
        },
        {
            'q': _('I am potential cerifier.  How do I get started?'),
            'a': _("The <a href=https://gitcoin.co/explorer>Funded TestTest Issue Explorer</a> contains test of issues that are ready to be paid out as soon as they are turned around.
            Check out the repo maintainers guide at <a href=https://gitcoin.co/help/repo>https://gitcoin.co/help/repo</a>.")
        },
        {
            'q': _('What tokens does eXitcoin support?'),
            'a': _("Gitcoin supports Ether and all ERC20 tokens.  If the token you'd like to use is Ethereum based, then eXitcoin supports it.")
        },
        {
...
>  Fund Issue (party 1) => claim funds  (party 2) => accept (party 1)
        ...
        {
            'q': _('What kind of testers, supporters or certifiers are successful with eXitcoin blockchain?'),
            'a': _("""

<p>
If you have an eye towards the future, read on..
</p>
<p>
If you would like to help support block chain application develoment, read on..
</p>
<p>
If you want to help to certifier our child lock testing, and receive Ether tokens in return, read on..
</p>
<p>
If you are looking for a way to participate in the movement to decentrilize currency with BLOCKCHAIN, rock on
</p>
...
<li>
     Create delightful experiences
        ...
        },
        {
            ...
            'a': _("As a general rule, we tend to treat the person wh o 'started work' first as having precedence over the issue.  The parties involved are all welcome to work together to split the bounty or come to some other agreement, but if an agreement is uanble to be made, then the first person to start work will have first shot at the bounty.")
        },
        ],
     'General': [
        {
            'q': _('Is eXitcoin open source?'),
            'a': _("Yes, all of eXitcoin's core software systems are open source and available at <a href=https://github.com/hempblock/web>https://github.com/hempblock/web</a>.  Please see the liscense.txt file in the repo for more details.")
        },
        {
...
<p>&nbsp;</p>            """)
        ...
        {
            'q': _('What is the difference between eXitcoin and Gitcoin ?'),
            'a': _("""
